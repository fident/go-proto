...
type AccountDetail struct {
	...
	Attributes []*AccountAttribute `protobuf:"bytes,4,rep,name=attributes" json:"attributes,omitempty"`
	Verified   string              `protobuf:"bytes,5,opt,name=verified" json:"verified,omitempty"`
	KeyHandle  string              `protobuf:"bytes,6,opt,name=key_handle,json=keyHandle" json:"key_handle,omitempty"`
}
...
func (m *AccountDetail) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *AccountDetail) GetVerified() string {
	if m != nil {
		return m.Verified
	}
	return ""
...
func (m *AccountDetail) GetKeyHandle() string {
	if m != nil {
		return m.KeyHandle
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	,
}
