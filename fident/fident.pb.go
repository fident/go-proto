...
func (m *TemporaryAuthtoken) Reset()                    { *m = TemporaryAuthtoken{} }
func (m *TemporaryAuthtoken) String() string            { return proto.CompactTextString(m) }
func (*TemporaryAuthtoken) ProtoMessage()               {}
func (*TemporaryAuthtoken) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }

func (m *TemporaryAuthtoken) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *TemporaryAuthtoken) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (m *TemporaryAuthtoken) GetDestination() string {
	if m != nil {
...
type CreateUserAccountResponse struct {
	IdentityId     string              `protobuf:"bytes,1,opt,name=identity_id,json=identityId" json:"identity_id,omitempty"`
	TemporaryToken *TemporaryAuthtoken `protobuf:"bytes,2,opt,name=temporary_token,json=temporaryToken" json:"temporary_token,omitempty"`
}
...
func (m *CreateUserAccountResponse) GetTemporaryToken() *TemporaryAuthtoken {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*TemporaryAuthtoken)(nil), "fident.TemporaryAuthtoken")
...
var fileDescriptor0 = []byte{
	...
	,
}
